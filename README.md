...
║   ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝   ╚═╝   ╚═╝  ╚═╝   ╚═════╝ ╚══════╝  ╚═══╝       ║
║                                                                                      ║
║          🔥 IDENTITY ENGINE v3.0 | Compiled with Passion 🔥                         ║
║                                                                                      ║
╚══════════════════════════════════════════════════════════════════════════════════════╝
...
int main(void) {
    ...
    Dev me[] = {
        ...
        {"🏆", "WINS",    "800+ LC | 3x Hackathon Winner"},
    ...
    printf(BOLD CYAN);
    printf("╔════════════════════════════════════════════════════════╗\n");
    printf("║" PINK " ⚡ BARATH.SYS — Systems Mode: ACTIVE ⚡ " CYAN "║\n");
    printf("╠════════════════════════════════════════════════════════╣\n" RESET);

    for (int i = 0; me[i].icon; i++) {
        printf(CYAN "║ " RESET);
        printf("%s " GOLD "%-8s" RESET " ➜ " GREEN "%s" RESET, 
               me[i].icon, me[i].key, me[i].value);
        printf(CYAN " ║\n" RESET);
    }
